    ...
    public static void registerCustomTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 2,
                factories -> {
                    ...
                    factories.add((entity, random) -> new TradeOffer(
                            new ItemStack(ModItems.SLICED_POTATO, 24),
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 3,
                factories -> {
                    factories.add((entity, random) -> new TradeOffer(
                            new ItemStack(ModItems.GAZPACHO, 1),
                            new ItemStack(ModItems.GARLIC, 20),
                            10, 8, 0.02F
                    ));

                    factories.add((entity, random) -> new TradeOffer(
                            new ItemStack(ModItems.BRAVA_POTATOES, 1),
                            new ItemStack(ModItems.RED_PEPPER, 20),
                            10, 8, 0.02F
                    ));

                    factories.add((entity, random) -> new TradeOffer(
                            new ItemStack(ModItems.PIL_PIL_COD, 1),
                            new ItemStack(ModItems.RED_PEPPER, 20),
                            10, 8, 0.02F
                    ));
                });
        ...
        TradeOfferHelper.registerWanderingTraderOffers(1,
                factories -> {
                    factories.add((entity, random) -> new TradeOffer(
                            new ItemStack(ModItems.GREEN_BEAN, 32),
                            new ItemStack(ModItems.GARLIC, 5),
                            10, 12, 0.1F
                    ));
